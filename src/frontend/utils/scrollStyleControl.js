export default function scrollControl() {
    let clipTabs = document.getElementById('cilp-tabs-wrapper');
   let slideContacts = document.getElementById('slide-contacts-id');
    ...
    window.onscroll = function () {
        ...
        if (clipTabs.classList.contains('fixed-clip-tabs') && window.pageYOffset < clipTabsSourceBottom) {
            clipTabs.classList.remove('fixed-clip-tabs');
